                ...
                <div class="activity-card card p-2 mb-2 mt-2">
                    <div class="card-body">
                        ...
                        <div class="card border-secondary p-2 mb-2">
                            ...
                            <input type="text" name="detail[{{ $index }}][pekerja]" value="{{ $detail->pekerja }}"
                                class="form-control">
                        ...
                        <div class="card border-secondary p-2 mb-2">
                            ...
                            <label class="fw-bold mb-3">Output :</label>

                            <input type="text" name="detail[{{ $index }}][output]" value="{{ $detail->output }}"
                                class="form-control">
